        ...
        >
          <div className="don-form-grid">
            ...
            <div className="don-form-group">
              <label className="don-form-label">
                Donante <span className="don-required">*</span>
              </label>
            ...
            <div className="don-form-group">
              <label className="don-form-label">
                Tipo <span className="don-required">*</span>
              </label>
            ...
            {tipoActual === 'Dinero' && (
              <div className="don-form-group">
                <label className="don-form-label">
                  Monto (₡) <span className="don-required">*</span>
                </label>
            ...
            {tipoActual === 'Especie' && (
              <>
                <div className="don-form-group">
                  <label className="don-form-label">
                    Descripción <span className="don-required">*</span>
                  </label>
                ...
                <div className="don-form-group">
                  <label className="don-form-label">
                    Cantidad <span className="don-required">*</span>
                  </label>
                ...
                <div className="don-form-group">
                  <label className="don-form-label">
                    Unidad <span className="don-required">*</span>
                  </label>
            ...
            <div className="don-form-group">
              <label className="don-form-label">
                Fecha <span className="don-required">*</span>
              </label>
